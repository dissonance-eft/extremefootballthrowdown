...
function ENT:Initialize()
	...
	self:SetColor(HSVToColor(math.random(0, 360), 1, 1))--self:SetColor(Color(255, 60, 255))
...
local Translated = {
	...
	[ACT_HL2MP_RUN_FAST] = ACT_HL2MP_RUN_MELEE2,
	[ACT_HL2MP_WALK_SLAM] = ACT_HL2MP_WALK_MELEE2,
	[ACT_MP_WALK] = ACT_HL2MP_WALK_MELEE2,
	[ACT_MP_CROUCH_IDLE] = ACT_HL2MP_IDLE_CROUCH_MELEE2,
	[ACT_MP_CROUCHWALK] = ACT_HL2MP_WALK_CROUCH_MELEE2,
	[ACT_HL2MP_IDLE_SLAM] = ACT_HL2MP_IDLE_MELEE2,
	[ACT_HL2MP_IDLE] = ACT_HL2MP_IDLE_MELEE2,
	[ACT_MP_JUMP] = ACT_HL2MP_JUMP_MELEE2,
    [ACT_HL2MP_SWIM] = ACT_HL2MP_SWIM_MELEE2,
    [ACT_HL2MP_SWIM_IDLE] = ACT_HL2MP_SWIM_IDLE_MELEE2
}
