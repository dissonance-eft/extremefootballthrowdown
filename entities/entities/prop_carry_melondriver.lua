...
local Translated = {
	...
	[ACT_HL2MP_WALK_SLAM] = ACT_HL2MP_WALK_PASSIVE,
	...
	[ACT_HL2MP_IDLE_SLAM] = ACT_HL2MP_IDLE_PASSIVE,
	[ACT_HL2MP_IDLE] = ACT_HL2MP_IDLE_PASSIVE,

	[ACT_MP_JUMP] = ACT_HL2MP_JUMP_PASSIVE,

	[ACT_HL2MP_SWIM] = ACT_HL2MP_SWIM_PASSIVE,
	[ACT_HL2MP_SWIM_IDLE] = ACT_HL2MP_SWIM_IDLE_PASSIVE
}
local TranslatedFiring = {
	[ACT_MP_RUN] = ACT_HL2MP_RUN_RPG,

	[ACT_HL2MP_WALK_SLAM] = ACT_HL2MP_WALK_RPG,
	...
	[ACT_HL2MP_IDLE_SLAM] = ACT_HL2MP_IDLE_RPG,
	[ACT_HL2MP_IDLE] = ACT_HL2MP_IDLE_RPG,

	[ACT_MP_JUMP] = ACT_HL2MP_JUMP_RPG,

	[ACT_HL2MP_SWIM] = ACT_HL2MP_SWIM_RPG,
	[ACT_HL2MP_SWIM_IDLE] = ACT_HL2MP_SWIM_IDLE_RPG
}
