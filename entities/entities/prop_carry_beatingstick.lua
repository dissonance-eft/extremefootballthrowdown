...
ENT.AttachmentOffset = Vector(10, 1, -10)
ENT.AttachmentAngles = Angle(50, 180, 5)
...
local Translated = {
	...
	[ACT_HL2MP_RUN_FAST] = ACT_HL2MP_RUN_MELEE,
	[ACT_HL2MP_WALK_SLAM] = ACT_HL2MP_WALK_MELEE,
	...
	[ACT_HL2MP_IDLE_SLAM] = ACT_HL2MP_IDLE_MELEE,
	[ACT_HL2MP_IDLE] = ACT_HL2MP_IDLE_MELEE,
	[ACT_MP_JUMP] = ACT_HL2MP_JUMP_MELEE,
